...
const symbolFileNameMap = [
  { value: "Transport", fileName: "dumper02_0" }, 
  { value: "gravemaskin01", fileName: "Gravemaskin_0" }, 
  { value: "gravemaskin02", fileName: "Gravemaskin_0" },
  { value: "gravemaskin03", fileName: "Gravemaskin_0" },  
  { value: "Heisekran", fileName: "kran1_0" },
  { value: "Dumper01", fileName: "dumper01_0" },
  { value: "Inspeksjonsbil", fileName: "PickUp_0" },
  { value: "Vals01", fileName: "Valse_0"}
]

const create3DSymbol = (symbolName) => {
  return {
    type: "point-3d",
    visualVariables: [{
      type: "rotation",
    ...
    symbolLayers: [{
      ...
      heading: 80,
      resource: {
        href: `${symbolsURL}/${symbolName}.glb`
      }
    }]
  }
}

const createIconSymbol = (url, color) => {
  return {
    type: "point-3d", 
...
const defaultPointSymbol = create3DSymbol("dumper02_0")

const rendererMaskin = {
  type: "unique-value",
  field: "event",
  defaultSymbol: defaultPointSymbol,
  uniqueValueInfos: symbolFileNameMap.map(s => {
    return {
      value: s.value,
      symbol: create3DSymbol(s.fileName)
    };
  }),
  visualVariables: [{
    type: "rotation",
...
let rendererMaskin2 = copyDeep(rendererMaskin)
rendererMaskin2.field = "name"
rendererMaskin2.visualVariables[0].field = "bearing"
...
const createStreamLayer = (url, renderer, mode, offset, labelClass = null) => {
  ...
  if (labelClass) layer["labelingInfo"] = [labelClass]
  return layer
}
